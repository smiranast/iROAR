...
def main(**kwargs):
    ...
    if args is None:
        ...
        parser.add_argument("--normalize",  help = "An approach used for OAR values normalization. Possible values: 'mean', 'median' (default=no normalization)", choices=['median', 'mean'], default=None, metavar='<str>')
